    ...
    public partial class WebForm21 : System.Web.UI.Page
    {
       ...
       /* private void setData()
        ...
        private void InsertDB()
        {
            ...
            LoadDB("Employee", "EmployeeId", 10000000, 1);
            SqlDataAdapter adapter = (SqlDataAdapter)Cache["Adapter"];
            DataSet ds = (DataSet)Cache["DataSet"];
            ...
            dr["LeaveDate"] = "No"; //Session["UserName"];
        ...
        {
            DataSet ds = (DataSet)Cache["DataSet"];
            DataRow lr = ds.Tables["Employee"].Rows[ds.Tables["Employee"].Rows.Count - 1];
            DataRow lrt = ds.Tables["Employee"].Rows[ds.Tables["Employee"].Rows.Count - 2];
            int Id = (int)lrt["EmployeeId"] + 1;
